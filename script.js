document.addEventListener('DOMContentLoaded', function() {
    ...
    const points = {
        'Squash Ball': [20, 12, 8, 6, 4, 3, 2, 0],
        'Golf Ball': [16, 16, 11, 7, 5, 4, 2, 1],
        'Tennis Ball': [12, 12, 14, 9, 7, 5, 3, 2],
        'Cricket Ball': [10, 10, 11, 12, 8, 6, 4, 4],
        'Baseball': [8, 8, 8, 9, 11, 8, 5, 5],
        'Soccer Ball': [6, 6, 7, 7, 8, 10, 7, 5],
        'Volleyball': [5, 5, 5, 6, 7, 9, 9, 7],
        'Basketball': [4, 4, 4, 4, 5, 6, 7, 8]
    };

    const correctOrder = [
        { city: 'Squash Ball', year: '4.00 cm' },
        { city: 'Golf Ball', year: '4.27 cm' },
        { city: 'Tennis Ball', year: '6.70 cm' },
        { city: 'Cricket Ball', year: '7.30 cm' },
        { city: 'Baseball', year: '7.50 cm' },
        { city: 'Soccer Ball', year: '22.00 cm' },
        { city: 'Volleyball', year: '22.10 cm' },
        { city: 'Basketball', year: '24.60 cm' }
    ];
